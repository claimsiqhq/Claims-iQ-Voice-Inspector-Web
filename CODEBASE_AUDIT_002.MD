...
3. **Unwired Replit integration routes**
   - **Location:** `server/replit_integrations/*`
   - **Severity:** Low
   - **Description:** Integration routes exist but are never registered.
   - **Recommendation:** Register behind feature flags or remove.
