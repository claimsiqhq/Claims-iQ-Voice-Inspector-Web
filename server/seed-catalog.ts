...
const ENHANCED_CATALOG: EnhancedCatalogItem[] = [
  ...
  // ─── DEM: Demolition ─────────────────────────────────────────────────────
  { code: "DEM-DRY-SF", trade: "DEM", desc: "Remove drywall, per SF", unit: "SF", waste: 0, quantityFormula: "WALL_SF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "DRY", notes: "Full wall drywall removal.", scopeConditions: { damage_types: ["water_intrusion", "water_stain", "mold"], surfaces: ["wall"], severity: ["severe"] }, companionRules: { auto_adds: ["DEM-HAUL-LD", "DRY-SHEET-SF"] } },
  { code: "DEM-CEIL-SF", trade: "DEM", desc: "Remove ceiling drywall, per SF", unit: "SF", waste: 0, quantityFormula: "CEILING_SF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "CEIL", notes: "Ceiling drywall removal.", scopeConditions: { damage_types: ["water_intrusion", "water_stain"], surfaces: ["ceiling"], severity: ["severe"] }, companionRules: { auto_adds: ["DEM-HAUL-LD", "DEM-INSUL-SF"] } },
  { code: "DEM-FLR-SF", trade: "DEM", desc: "Remove flooring, per SF", unit: "SF", waste: 0, quantityFormula: "FLOOR_SF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "FLR", notes: "Generic flooring removal.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"], severity: ["moderate", "severe"] }, companionRules: { auto_adds: ["DEM-HAUL-LD"] } },
  { code: "DEM-PAD-SF", trade: "DEM", desc: "Remove carpet pad, per SF", unit: "SF", waste: 0, quantityFormula: "FLOOR_SF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "PAD", notes: "Carpet pad removal.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { auto_adds: ["DEM-HAUL-LD"] } },
  { code: "DEM-TILE-SF", trade: "DEM", desc: "Remove ceramic tile, per SF", unit: "SF", waste: 0, quantityFormula: "FLOOR_SF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "TILE", notes: "Ceramic/porcelain tile removal.", scopeConditions: { damage_types: ["water_intrusion", "crack"], surfaces: ["floor"] }, companionRules: { auto_adds: ["DEM-HAUL-LD"], excludes: ["DEM-FLR-SF"] } },
  { code: "DEM-CAB-LF", trade: "DEM", desc: "Remove base cabinets, per LF", unit: "LF", waste: 0, quantityFormula: "MANUAL", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "CAB", notes: "Base cabinet removal.", scopeConditions: { damage_types: ["water_intrusion"], room_types: ["interior_kitchen", "interior_bathroom", "interior_laundry"] }, companionRules: { auto_adds: ["DEM-HAUL-LD"] } },
  { code: "DEM-TRIM-LF", trade: "DEM", desc: "Remove trim/baseboard, per LF", unit: "LF", waste: 0, quantityFormula: "PERIMETER_LF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "TRIM", notes: "Baseboard/trim removal.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { auto_adds: ["FLR-TRIM-LF"] } },
  { code: "DEM-HAUL-LD", trade: "DEM", desc: "Haul debris, per load", unit: "LD", waste: 0, quantityFormula: "MANUAL", activityType: "labor_only", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "HAUL", notes: "Debris haul-off.", scopeConditions: null, companionRules: { auto_adds: ["DEM-DUMP-LD"] } },
  { code: "DEM-DUMP-LD", trade: "DEM", desc: "Dump fees, per load", unit: "LD", waste: 0, quantityFormula: "MANUAL", activityType: "labor_only", coverageType: "A", xactCategoryCode: "FEE", xactSelector: "DUMP", notes: "Disposal/dump fees.", scopeConditions: null, companionRules: {} },
  { code: "DEM-INSUL-SF", trade: "DEM", desc: "Remove insulation, per SF", unit: "SF", waste: 0, quantityFormula: "CEILING_SF", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "INSUL", notes: "Insulation removal from ceiling/attic.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["ceiling"] }, companionRules: { auto_adds: ["INS-BATTS-SF"] } },
  { code: "DEM-VANITY-EA", trade: "DEM", desc: "Remove vanity, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "remove", coverageType: "A", xactCategoryCode: "DMO", xactSelector: "VANITY", notes: "Vanity removal.", scopeConditions: { damage_types: ["water_intrusion"], room_types: ["interior_bathroom"] }, companionRules: { auto_adds: ["DEM-HAUL-LD"] } },
  ...
  // ─── FLR: Flooring ───────────────────────────────────────────────────────
  { code: "FLR-TILE-SF", trade: "FLR", desc: "Ceramic tile flooring, per SF", unit: "SF", waste: 15, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "FCT", xactSelector: "TILE", notes: "Ceramic/porcelain tile installation.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { requires: ["DEM-FLR-SF"], auto_adds: ["FLR-GROUT-SF", "FLR-MORTAR-SF"] } },
  { code: "FLR-VINYL-SF", trade: "FLR", desc: "Vinyl plank flooring, per SF", unit: "SF", waste: 10, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "FCV", xactSelector: "VINYL", notes: "LVT or vinyl plank flooring.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { requires: ["DEM-FLR-SF"] } },
  { code: "FLR-LAMINATE-SF", trade: "FLR", desc: "Laminate flooring, per SF", unit: "SF", waste: 12, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "FCR", xactSelector: "LAM", notes: "Laminate flooring installation.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { requires: ["DEM-FLR-SF"], auto_adds: ["FLR-PAD-SF"] } },
  { code: "FLR-WOOD-SF", trade: "FLR", desc: "Hardwood flooring, per SF", unit: "SF", waste: 10, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "FCW", xactSelector: "HWD", notes: "Solid or engineered hardwood.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { requires: ["DEM-FLR-SF"] } },
  { code: "FLR-CARPET-SF", trade: "FLR", desc: "Carpet installation, per SF", unit: "SF", waste: 12, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "FCC", xactSelector: "CAR", notes: "Carpet installation.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["floor"] }, companionRules: { requires: ["DEM-FLR-SF"], auto_adds: ["FLR-PAD-SF"] } },
  { code: "FLR-PAD-SF", trade: "FLR", desc: "Underlayment, per SF", unit: "SF", waste: 8, quantityFormula: "FLOOR_SF", activityType: "install", coverageType: "A", xactCategoryCode: "FCC", xactSelector: "PAD", notes: "Carpet pad or underlayment.", scopeConditions: null, companionRules: {} },
  { code: "FLR-GROUT-SF", trade: "FLR", desc: "Tile grout, per SF", unit: "SF", waste: 10, quantityFormula: "FLOOR_SF", activityType: "install", coverageType: "A", xactCategoryCode: "FCT", xactSelector: "GROUT", notes: "Tile grout application.", scopeConditions: null, companionRules: { auto_adds: ["FLR-SEALANT-SF"] } },
  { code: "FLR-MORTAR-SF", trade: "FLR", desc: "Tile mortar, per SF", unit: "SF", waste: 10, quantityFormula: "FLOOR_SF", activityType: "install", coverageType: "A", xactCategoryCode: "FCT", xactSelector: "MORTAR", notes: "Thinset mortar for tile.", scopeConditions: null, companionRules: {} },
  { code: "FLR-SEALANT-SF", trade: "FLR", desc: "Grout/tile sealant, per SF", unit: "SF", waste: 8, quantityFormula: "FLOOR_SF", activityType: "install", coverageType: "A", xactCategoryCode: "FCT", xactSelector: "SEAL", notes: "Grout sealant.", scopeConditions: null, companionRules: {} },
  { code: "FLR-TRIM-LF", trade: "FLR", desc: "Floor trim/molding, per LF", unit: "LF", waste: 10, quantityFormula: "PERIMETER_LF", activityType: "install", coverageType: "A", xactCategoryCode: "FNC", xactSelector: "TRIM", notes: "Baseboard after flooring replacement.", scopeConditions: null, companionRules: { auto_adds: ["PNT-TRIM-LF"] } },
  ...
  // ─── CAR: Carpentry ───────────────────────────────────────────────────────
  { code: "CAR-FRAME-LF", trade: "CAR", desc: "Wood framing, per LF", unit: "LF", waste: 10, quantityFormula: "MANUAL", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "FRAME", notes: "Wood framing member.", scopeConditions: null, companionRules: {} },
  { code: "CAR-SHEATH-SF", trade: "CAR", desc: "Wall sheathing, per SF", unit: "SF", waste: 10, quantityFormula: "WALL_SF", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "SHEATH", notes: "Wall sheathing.", scopeConditions: { zone_types: ["exterior"] }, companionRules: { requires: ["EXT-WRAP-SF"] } },
  { code: "CAR-DECK-SF", trade: "CAR", desc: "Deck construction, per SF", unit: "SF", waste: 15, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "XST", xactSelector: "DECK", notes: "Deck construction.", scopeConditions: { zone_types: ["exterior"] }, companionRules: {} },
  { code: "CAR-BEAM-LF", trade: "CAR", desc: "Header beam installation, per LF", unit: "LF", waste: 5, quantityFormula: "MANUAL", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "BEAM", notes: "Header beam.", scopeConditions: null, companionRules: {} },
  { code: "CAR-RAFTER-LF", trade: "CAR", desc: "Rafter installation, per LF", unit: "LF", waste: 8, quantityFormula: "ROOF_SF", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "RAFTER", notes: "Rafter installation.", scopeConditions: { damage_types: ["wind", "hail"], surfaces: ["roof"] }, companionRules: { auto_adds: ["RFG-UNDER-SF"] } },
  { code: "CAR-PORCH-SF", trade: "CAR", desc: "Porch floor construction, per SF", unit: "SF", waste: 12, quantityFormula: "FLOOR_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "XST", xactSelector: "PORCH", notes: "Porch floor.", scopeConditions: { zone_types: ["exterior"] }, companionRules: {} },
  { code: "CAR-JOISTS-LF", trade: "CAR", desc: "Floor joist installation, per LF", unit: "LF", waste: 8, quantityFormula: "MANUAL", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "JOIST", notes: "Floor joist.", scopeConditions: null, companionRules: {} },
  { code: "CAR-SILL-LF", trade: "CAR", desc: "Sill plate/band board, per LF", unit: "LF", waste: 5, quantityFormula: "PERIMETER_LF", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "SILL", notes: "Sill plate.", scopeConditions: null, companionRules: {} },
  { code: "CAR-BLOCKING-LF", trade: "CAR", desc: "Blocking/bracing, per LF", unit: "LF", waste: 10, quantityFormula: "MANUAL", activityType: "install", coverageType: "A", xactCategoryCode: "FRM", xactSelector: "BLOCK", notes: "Blocking/bracing.", scopeConditions: null, companionRules: {} },
  { code: "CAR-STAIR-EA", trade: "CAR", desc: "Stair assembly, each", unit: "EA", waste: 10, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "STR", xactSelector: "STAIR", notes: "Stair assembly.", scopeConditions: null, companionRules: {} },
  { code: "CAR-LANDING-SF", trade: "CAR", desc: "Landing platform, per SF", unit: "SF", waste: 12, quantityFormula: "FLOOR_SF", activityType: "install", coverageType: "A", xactCategoryCode: "STR", xactSelector: "LAND", notes: "Landing platform.", scopeConditions: null, companionRules: {} },
  { code: "CAR-SOFFIT-SF", trade: "CAR", desc: "Soffit framing, per SF", unit: "SF", waste: 10, quantityFormula: "MANUAL", activityType: "install", coverageType: "A", xactCategoryCode: "SFG", xactSelector: "SOFF", notes: "Soffit framing.", scopeConditions: null, companionRules: {} },
  ...
  // ─── WIN: Windows ────────────────────────────────────────────────────────
  { code: "WIN-DOUBLE-EA", trade: "WIN", desc: "Double-hung window, each", unit: "EA", waste: 5, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "WDV", xactSelector: "DH", notes: "Double-hung window.", scopeConditions: { damage_types: ["wind", "hail"], surfaces: ["window"] }, companionRules: { auto_adds: ["WIN-SEAL-LF"] } },
  { code: "WIN-CASEMENT-EA", trade: "WIN", desc: "Casement window, each", unit: "EA", waste: 5, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "WDV", xactSelector: "CAS", notes: "Casement window.", scopeConditions: { damage_types: ["wind", "hail"], surfaces: ["window"] }, companionRules: { auto_adds: ["WIN-SEAL-LF"] } },
  { code: "WIN-PICTURE-EA", trade: "WIN", desc: "Picture window, each", unit: "EA", waste: 5, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "WDV", xactSelector: "PIC", notes: "Picture window.", scopeConditions: { damage_types: ["wind", "hail"], surfaces: ["window"] }, companionRules: { auto_adds: ["WIN-SEAL-LF"] } },
  { code: "WIN-GLASS-SF", trade: "WIN", desc: "Window glass replacement, per SF", unit: "SF", waste: 10, quantityFormula: "MANUAL", activityType: "repair", coverageType: "A", xactCategoryCode: "WDR", xactSelector: "GLASS", notes: "Glass replacement only.", scopeConditions: { damage_types: ["wind", "hail"], surfaces: ["window"] }, companionRules: {} },
  { code: "WIN-FRAME-EA", trade: "WIN", desc: "Window frame repair, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "repair", coverageType: "A", xactCategoryCode: "WDR", xactSelector: "FRAME", notes: "Window frame repair.", scopeConditions: null, companionRules: {} },
  { code: "WIN-SEAL-LF", trade: "WIN", desc: "Window caulking/sealing, per LF", unit: "LF", waste: 5, quantityFormula: "PERIMETER_LF", activityType: "install", coverageType: "A", xactCategoryCode: "WDR", xactSelector: "SEAL", notes: "Caulking/sealing.", scopeConditions: null, companionRules: {} },
  { code: "WIN-SILL-LF", trade: "WIN", desc: "Window sill replacement, per LF", unit: "LF", waste: 8, quantityFormula: "MANUAL", activityType: "replace", coverageType: "A", xactCategoryCode: "FNC", xactSelector: "SILL", notes: "Window sill replacement.", scopeConditions: { damage_types: ["water_intrusion"], surfaces: ["window"] }, companionRules: {} },
  { code: "WIN-SCREEN-EA", trade: "WIN", desc: "Window screen, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "install", coverageType: "A", xactCategoryCode: "WDV", xactSelector: "SCREEN", notes: "Window screen.", scopeConditions: null, companionRules: {} },

  // ─── EXT: Exterior ───────────────────────────────────────────────────────
  { code: "EXT-SIDING-SF", trade: "EXT", desc: "Vinyl siding, per SF", unit: "SF", waste: 10, quantityFormula: "WALL_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "SDG", xactSelector: "VINYL", notes: "Vinyl siding.", scopeConditions: { damage_types: ["wind", "hail"], zone_types: ["exterior"], surfaces: ["wall"] }, companionRules: { auto_adds: ["EXT-WRAP-SF"] } },
  { code: "EXT-BRICK-SF", trade: "EXT", desc: "Brick veneer, per SF", unit: "SF", waste: 8, quantityFormula: "WALL_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "MAS", xactSelector: "BRICK", notes: "Brick veneer.", scopeConditions: { damage_types: ["wind", "hail"], zone_types: ["exterior"], surfaces: ["wall"] }, companionRules: {} },
  { code: "EXT-STONE-SF", trade: "EXT", desc: "Stone veneer, per SF", unit: "SF", waste: 10, quantityFormula: "WALL_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "MAS", xactSelector: "STONE", notes: "Stone veneer.", scopeConditions: { damage_types: ["wind", "hail"], zone_types: ["exterior"], surfaces: ["wall"] }, companionRules: {} },
  { code: "EXT-STUCCO-SF", trade: "EXT", desc: "Stucco application, per SF", unit: "SF", waste: 12, quantityFormula: "WALL_SF", activityType: "replace", coverageType: "A", xactCategoryCode: "STU", xactSelector: "STUCCO", notes: "Stucco application.", scopeConditions: { damage_types: ["wind", "hail"], zone_types: ["exterior"], surfaces: ["wall"] }, companionRules: {} },
  { code: "EXT-WRAP-SF", trade: "EXT", desc: "House wrap, per SF", unit: "SF", waste: 5, quantityFormula: "WALL_SF", activityType: "install", coverageType: "A", xactCategoryCode: "MPR", xactSelector: "WRAP", notes: "House wrap.", scopeConditions: null, companionRules: {} },
  { code: "EXT-FASCIA-LF", trade: "EXT", desc: "Fascia board, per LF", unit: "LF", waste: 10, quantityFormula: "PERIMETER_LF", activityType: "replace", coverageType: "A", xactCategoryCode: "SFG", xactSelector: "FASCIA", notes: "Fascia board.", scopeConditions: { damage_types: ["wind", "hail"], zone_types: ["exterior"] }, companionRules: { auto_adds: ["EXT-SOFFIT-SF"] } },
  { code: "EXT-SOFFIT-SF", trade: "EXT", desc: "Soffit panel, per SF", unit: "SF", waste: 12, quantityFormula: "MANUAL", activityType: "replace", coverageType: "A", xactCategoryCode: "SFG", xactSelector: "SOFFIT", notes: "Soffit panel.", scopeConditions: { damage_types: ["wind", "hail"], zone_types: ["exterior"] }, companionRules: {} },
  { code: "EXT-CORNER-LF", trade: "EXT", desc: "Corner trim, per LF", unit: "LF", waste: 5, quantityFormula: "MANUAL", activityType: "install", coverageType: "A", xactCategoryCode: "SDG", xactSelector: "CORNER", notes: "Corner trim.", scopeConditions: null, companionRules: {} },
  { code: "EXT-DOOR-EA", trade: "EXT", desc: "Exterior door, each", unit: "EA", waste: 5, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "DOR", xactSelector: "DOOR", notes: "Exterior door.", scopeConditions: { damage_types: ["wind", "water_intrusion"], surfaces: ["door"] }, companionRules: {} },
  { code: "EXT-GARAGE-EA", trade: "EXT", desc: "Garage door, each", unit: "EA", waste: 5, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "DOR", xactSelector: "GARAGE", notes: "Garage door.", scopeConditions: { damage_types: ["wind", "hail"], surfaces: ["door"] }, companionRules: {} },
  ...
  // ─── HVAC ─────────────────────────────────────────────────────────────────
  { code: "HVAC-DUCT-LF", trade: "HVAC", desc: "Flexible ductwork, per LF", unit: "LF", waste: 10, quantityFormula: "MANUAL", activityType: "replace", coverageType: "A", xactCategoryCode: "HVC", xactSelector: "DUCT", notes: "Flexible HVAC duct replacement.", scopeConditions: null, companionRules: {} },
  { code: "HVAC-VENT-EA", trade: "HVAC", desc: "Supply vent/register, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "HVC", xactSelector: "VENT", notes: "Supply vent or register cover.", scopeConditions: null, companionRules: {} },
  { code: "HVAC-RETN-EA", trade: "HVAC", desc: "Return air grille, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "HVC", xactSelector: "RETN", notes: "Return air grille cover.", scopeConditions: null, companionRules: {} },
  { code: "HVAC-THERM-EA", trade: "HVAC", desc: "Thermostat - standard, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "replace", coverageType: "A", xactCategoryCode: "HVC", xactSelector: "THERM", notes: "Standard programmable thermostat.", scopeConditions: null, companionRules: {} },
  { code: "HVAC-CLEAN-EA", trade: "HVAC", desc: "Duct cleaning, each system", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "clean", coverageType: "A", xactCategoryCode: "HVC", xactSelector: "CLEN", notes: "Full duct system cleaning after water/fire damage.", scopeConditions: { damage_types: ["water_intrusion", "mold"] }, companionRules: {} },

  // ─── GEN: General Conditions ───────────────────────────────────────────────
  { code: "GEN-PROT-SF", trade: "GEN", desc: "Floor protection - temporary, per SF", unit: "SF", waste: 0, quantityFormula: "FLOOR_SF", activityType: "install", coverageType: "A", xactCategoryCode: "TMP", xactSelector: "PROT", notes: "Ram board or poly protection for floors during construction. Add when 3+ trades.", scopeConditions: null, companionRules: {} },
  { code: "GEN-CLEAN-SF", trade: "GEN", desc: "Final construction cleaning, per SF", unit: "SF", waste: 0, quantityFormula: "FLOOR_SF", activityType: "clean", coverageType: "A", xactCategoryCode: "CLN", xactSelector: "CLEN", notes: "Post-construction detail cleaning.", scopeConditions: null, companionRules: {} },
  { code: "GEN-SUPER-HR", trade: "GEN", desc: "Supervision/project management, per HR", unit: "HR", waste: 0, quantityFormula: "MANUAL", activityType: "labor_only", coverageType: "A", xactCategoryCode: "LAB", xactSelector: "SUPR", notes: "On-site supervision/project management.", scopeConditions: null, companionRules: {} },
  { code: "GEN-PERMIT-EA", trade: "GEN", desc: "Building permit, each", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "labor_only", coverageType: "A", xactCategoryCode: "FEE", xactSelector: "PERM", notes: "Building permit fee. Required for structural, electrical, or plumbing work.", scopeConditions: null, companionRules: {} },
  { code: "GEN-CONTENT-EA", trade: "GEN", desc: "Contents move-out and reset, each room", unit: "EA", waste: 0, quantityFormula: "EACH", activityType: "labor_only", coverageType: "C", xactCategoryCode: "CON", xactSelector: "CONT", notes: "Move room contents out for work, then move back. Coverage C item.", scopeConditions: null, companionRules: {} },
];
